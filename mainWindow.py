...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.step_size.setGeometry(QtCore.QRect(50, 270, 101, 22))
        self.step_size.setMaximum(10000000)
        self.step_size.setProperty("value", 10)
        ...
        self.step_max.setGeometry(QtCore.QRect(50, 300, 101, 22))
        self.step_max.setMaximum(10000000)
        self.step_max.setProperty("value", 10000)
        ...
        self.tn.setGeometry(QtCore.QRect(50, 360, 101, 22))
        ...
        self.t0.setGeometry(QtCore.QRect(50, 330, 101, 22))
